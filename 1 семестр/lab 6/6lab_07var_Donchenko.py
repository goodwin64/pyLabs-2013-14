# 7) Прибрати зі списку усі дублі елементів. У результаті має бути отриманий
# кортеж без дублів. Наприклад [1, -2, 3, 1, 4, -2] -> (1, -2, 3, 4)
...
while True:
    ...
    while True:
        ...
        if Array.count(E)==1: # в случае, если элемент не повторяется, переходим к следующему
            ...
            while Array.count(E)>1: # и в случае повторений элементов вносим изменения в массив
                del Array[Array.index(E)] # т.е. удаляем из него те элементы, которые повторяются в копии
